---
title: 'Designing an Ornithopter'
draft: false
hidemeta: true
---

<div style="text-align: center; padding: 1rem 1rem; font-family: sans-serif; line-height: 1.3">

  <h1 style="font-size: 3rem; margin-bottom: 0.25rem;">Java Murray</h1>
</div>

<div style="text-align: center; padding: 1rem 1rem; font-family: sans-serif;">
  <h1 style="font-size: 2rem; margin: 0;">DMA Project</h1>
</div>
...
The goal of this was to be more simple and have less moving parts.
